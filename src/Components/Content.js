  ...
  return (
    <section>
      <Row className="contentNotLogin">
        <Col className="contentText" xl={7} md={6} sm={6} xs={8}>
        ...
        <Col className="contentPicture" xl={5} md={5} sm={6} xs={8}>
          <img src={logo} alt="Kitap" />
        </Col>
      </Row>
      <Row className="contentPropRow">
        <Col className="contentPropHead mt-5" xl={8} md={8} sm={8} xs={8}>
          <h2>Günlük Özellikleri</h2>
          <span>
            Sanal günlüğünüzü özelliştirebilmeniz için bir kaç seçenek.
          </span>
        </Col>
        <Col className="contentProps" xl={8} md={8} sm={8} xs={8}>
          <Col xl={3} md={6} sm={12} xs={12}>
            <Card style={{border: "none" }}>
              <Card.Body>
                ...
                Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam
            egestas magna aliquet nulla mollis gravida. Aenean cursus, quam id
            gravida porta, mi augue porttitor nisi.
                </Card.Text>
              </Card.Body>
            </Card>
          </Col>
